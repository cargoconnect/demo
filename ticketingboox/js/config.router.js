    ...
    [          '$stateProvider', '$urlRouterProvider', 'JQ_CONFIG', 'MODULE_CONFIG', 
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
          ...
          $stateProvider
              ...
              .state('app.ticket.tikcet', {
                  url: '/ticket',
                  templateUrl: 'tpl/ticket/ticket.html'
              })
              .state('app.ticket.report', {
                  url: '/report',
                  templateUrl: 'tpl/ticket/report.html',
                  resolve: load('js/controllers/chart.js')
              })
              ...
              .state('app.data.information', {
                  url: '/information',
                  templateUrl: 'tpl/data/information.html'
              })
              .state('app.data.knowledge', {
                  url: '/knowledge',
                  templateUrl: 'tpl/data/knowledge.html'
              })
              .state('app.data.report', {
                  url: '/report',
                  templateUrl: 'tpl/data/report.html',
                  resolve: load('js/controllers/chart.js')
              })
              ...
              .state('app.map.engineer', {
                  url: '/engineer',
                  templateUrl: 'tpl/map/engineer.html',
                  resolve: load('js/controllers/map.js')
              })
